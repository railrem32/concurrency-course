...
//private ExecutorService executor = new ThreadPoolExecutor(6, 12, 60L, TimeUnit.SECONDS,
//        new SynchronousQueue<Runnable>());

//    private ExecutorService executor = new ThreadPoolExecutor(6, 6, 60L, TimeUnit.SECONDS,
//            new SynchronousQueue<>());

//    private ExecutorService executor = new ThreadPoolExecutor(3, 6, 60L, TimeUnit.SECONDS,
//            new SynchronousQueue<>());
